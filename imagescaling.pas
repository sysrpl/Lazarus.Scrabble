...
function NewBitmap: TRasterImage; overload;
function NewBitmap(W, H: Integer): TRasterImage; overload;

implementation

function NewBitmap: TRasterImage;
begin
...
type
  {$ifdef linux}
  TPixel = record Red, Green, Blue, Alpha: Byte; end;
  {$else}
